...
if( isset($_POST["submit"])){
    ...
    mysqli_query($koneksi, "INSERT INTO tb_publisher VALUES('$id','$nama','$alamat','$kota', '$telepon')");
...
<br>
    <h1 align="center">Tambah Data Penerbit</h1>

    <form action="" method="post" enctype="multipart/form-data">
    <table align="center">
    <tr>
         <td><label for="id" class="form-label mt-4">ID Penerbit</label>
         <input type="text" size="60" class="form-control mt-2 ms-3" id="id" name="id" aria-describedby="emailHelp" required></td>
    </tr>
    <tr>
